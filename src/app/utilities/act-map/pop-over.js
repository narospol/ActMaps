(function(global, factory) {
    if (typeof define === "function" && define.amd) {
        define('PopOverWindow', ['module', 'exports'], factory);
        ...
        global.PopOverWindow = mod.exports;
    }
    ...
    // Global variables
    var _classPrefix = 'pop-';
    var _eventPrefix = 'pop-over-window-';
    ...
    // Export PopOverWindow even if google is not yet defined.
    var getGoogleClass = function getGoogleClass() {
        return typeof google !== 'undefined' ? google.maps.OverlayView : function noop() {};
    };

    var PopOverWindow = function(_getGoogleClass) {
        _inherits(PopOverWindow, _getGoogleClass);

        function PopOverWindow(opts) {
            _classCallCheck(this, PopOverWindow);

            var _this = _possibleConstructorReturn(this, (PopOverWindow.__proto__ || Object.getPrototypeOf(PopOverWindow)).call(this, opts));

            if (typeof google === 'undefined') {
                console.warn('Pop Over Window: Google Maps is not defined!'); //eslint-disable-line
            ...
            _classPrefix = _this._opts.classPrefix || _classPrefix;
            _eventPrefix = _this._opts.eventPrefix || _eventPrefix;
        ...
        _createClass(PopOverWindow, [{
            ...
            value: function onAdd() {
                ...
                // Content Wrapper Click mouseover
                if (this._opts.isHandleBackground) {
                    this.trackListener(google.maps.event.addDomListener(_this2._html.contentWrapper, 'click', function(e) {
                        e.cancelBubble = true;
